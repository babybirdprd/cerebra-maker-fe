...
export const Sidebar: React.FC<SidebarProps> = ({ currentView, onChangeView, className = '' }) => {
  return (
    <div className={`w-64 h-full bg-zinc-950 border-r border-zinc-800 flex flex-col justify-between ${className}`}>
      ...
      <div className="p-4 border-t border-zinc-800">
        ...
        <button className="flex items-center gap-3 px-3 py-2 text-zinc-400 hover:text-white w-full text-sm">
          <Settings size={18} />
          Settings
        </button>
      </div>
...
export const MobileNav: React.FC<SidebarProps> = ({ currentView, onChangeView, className = '' }) => {
  return (
    <div className={`h-16 bg-zinc-950 border-t border-zinc-800 flex items-center justify-around px-2 ${className}`}>
      ...
      <button className="flex flex-col items-center justify-center p-2 text-zinc-500 hover:text-zinc-300">
          <Settings size={20} />
