        ...
        <div className="bg-zinc-900 border border-zinc-800 p-4 rounded-lg relative overflow-hidden group">
            ...
            <div className="flex justify-between items-start">
                <div>
                    ...
                    <p className="text-2xl font-mono text-white mt-1">50 Agents</p>
                </div>
                <Cpu className="text-indigo-500" />
            </div>
            <div className="mt-2 text-xs text-indigo-400 font-mono">Processing: 24,000 t/s</div>
        </div>
        <div className="bg-zinc-900 border border-zinc-800 p-4 rounded-lg">
            <div className="flex justify-between items-start">
                <div>
                    <h3 className="text-zinc-400 text-xs uppercase font-bold tracking-wider">Grits Red-Flags</h3>
                    <p className="text-2xl font-mono text-white mt-1">2 Rejected</p>
                </div>
                <AlertTriangle className="text-amber-500" />
            </div>
             <div className="mt-2 text-xs text-amber-500 font-mono">Cycle Detected</div>
        </div>
        <div className="bg-zinc-900 border border-zinc-800 p-4 rounded-lg">
            <div className="flex justify-between items-start">
                <div>
                    <h3 className="text-zinc-400 text-xs uppercase font-bold tracking-wider">Shadow Commits</h3>
                    <p className="text-2xl font-mono text-white mt-1">483</p>
                </div>
